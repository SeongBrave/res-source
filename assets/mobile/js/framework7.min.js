...
function() {
    ...
    window.Framework7 = function(a) {
        ...
        i.actions = function(e, a) {
            ...
            var p;
            if (s) {
                var d = i.params.modalActionsToPopoverTemplate || '<div class="popover actions-popover"><div class="popover-inner">{{#each this}}<div class="list-block"><ul>{{#each this}}{{#if label}}<li class="actions-popover-label {{#if color}}color-{{color}}{{/if}} {{#if bold}}actions-popover-bold{{/if}}">{{text}}</li>{{else}}<li><a href="#" data-ajax="false"  class="item-link list-button {{#if color}}color-{{color}}{{/if}} {{#if bg}}bg-{{bg}}{{/if}} {{#if bold}}actions-popover-bold{{/if}} {{#if disabled}}disabled{{/if}}">{{text}}</a></li>{{/if}}{{/each}}</ul></div>{{/each}}</div></div>';
        ...
        i.initSwipeout = function(e) {
            ...
            function n(e) {
                ...
                if (T = "to-left" === x ? I: M, n = "to-left" === x ? m: f, t = "to-left" === x ? g: h, a = 300 > k && ( - 10 > d && "to-left" === x || d > 10 && "to-right" === x) || k >= 300 && Math.abs(v) > t / 2 ? "open": "close", 300 > k && (0 === Math.abs(v) && (a = "close"), Math.abs(v) === t && (a = "open")), "open" === a) {
					...
					//n.find
					for(var ew=0;ew<$(".list-block li").length;ew++){
							
						if($(this).eq(ew).find(".Goods-list").css("margin-left")!="0px"){
							$(this).eq(ew).find(".Goods-list").animate({marginLeft:0+"%"},300);
							$(this).eq(ew).find(".Collection-Bot").animate({right:2+"%"},300);
							$(this).eq(ew).find(".Collect-bot").animate({right:0+"%"},300);	
							$(this).eq(ew).find(".Goods-Bot").animate({right:4.62+"%"},300);
							
						}
					}
					$(this).find(".Goods-list").animate({marginLeft:-13.33+"%"},300);
					$(this).find(".Collection-Bot").animate({right:15.33+"%"},300);
					$(this).find(".Collect-bot").animate({right:13.33+"%"},300);
					$(this).find(".Goods-Bot").animate({right:17+"%"},300);
				...
				if($(this).attr("class")!="swipeout swipeout-opened transitioning"){
					$(this).find(".Goods-list").animate({marginLeft:0+"%"},300);
					$(this).find(".Collection-Bot").animate({right:2+"%"},300);
					$(this).find(".Collect-bot").animate({right:0+"%"},300);
					$(this).find(".Goods-Bot").animate({right:4.62+"%"},300);
				}
                var E;
            ...
            if (e = o(e), 0 !== e.length) {
                ...
                if (0 !== r.length) {
                    ...
                    if (! (w.disabled || e.hasClass("disabled") || C.hasClass("disabled"))) {
                        ...
                        var Y,
                        G = i._compiledTemplates.smartSelectNavbar({
                            pageTitle: d,
                            backText: c,
                            closeText: u,
                            openIn: s,
                            ...
                            inPopup: "popup" === s,
                            inPage: "page" === s,
                            leftTemplate: "popup" === s ? (i.params.smartSelectPopupCloseTemplate || (b ? '<div class="left"><a href="#" data-ajax="false"  class="link close-popup icon-only"><i class="icon icon-back"></i></a></div>': '<div class="left"><a href="#" data-ajax="false"  class="link close-popup"><i class="icon icon-back"></i><span>{{closeText}}</span></a></div>')).replace(/{{closeText}}/g, u) : (i.params.smartSelectBackTemplate || (b ? '<div class="left"><a href="#" data-ajax="false"  class="back link icon-only"><i class="icon icon-back"></i></a></div>': '<div class="left sliding"><a href="#" data-ajax="false"  class="back link"><i class="icon icon-back"></i><span>{{backText}}</span></a></div>')).replace(/{{backText}}/g, c)
                        }),
                        W = "",
                        j = "";
                        ...
                        var K,
                        Q = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + N + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + _ + '"><a href="#" data-ajax="false"  class="searchbar-clear"></a></div>' + (b ? "": '<a href="#" data-ajax="false"  class="searchbar-cancel">' + X + "</a>") + '</form><div class="searchbar-overlay"></div>',
        ...
        var v = function(e) {
            ...
            c = a.params.navbarTemplate || '<div class="navbar"><div class="navbar-inner"><div class="left sliding"><a href="#" data-ajax="false"  class="link close-popup photo-browser-close-link {{#unless backLinkText}}icon-only{{/unless}} {{js "this.type === \'page\' ? \'back\' : \'\'"}}"><i class="icon icon-back {{iconsColorClass}}"></i>{{#if backLinkText}}<span>{{backLinkText}}</span>{{/if}}</a></div><div class="center sliding"><span class="photo-browser-current"></span> <span class="photo-browser-of">{{ofText}}</span> <span class="photo-browser-total"></span></div><div class="right"></div></div></div>',
            u = a.params.toolbarTemplate || '<div class="toolbar tabbar"><div class="toolbar-inner"><a href="#" data-ajax="false"  class="link photo-browser-prev"><i class="icon icon-prev {{iconsColorClass}}"></i></a><a href="#" data-ajax="false"  class="link photo-browser-next"><i class="icon icon-next {{iconsColorClass}}"></i></a></div></div>',
        ...
        var b = function(e) {
            ...
            d = {
                ...
                toolbarTemplate: '<div class="toolbar"><div class="toolbar-inner"><div class="left"></div><div class="right"><a href="#" data-ajax="false"  class="link close-picker">{{closeText}}</a></div></div></div>'
            };
            e = e || {};
        ...
        var w = function(e) {
            ...
            d = {
                ...
                closeOnSelect: !1,
                monthPicker: !0,
                monthPickerTemplate: '<div class="picker-calendar-month-picker"><a href="#" data-ajax="false"  class="link icon-only picker-calendar-prev-month"><i class="icon icon-prev"></i></a><span class="current-month-value"></span><a href="#" data-ajax="false"  class="link icon-only picker-calendar-next-month"><i class="icon icon-next"></i></a></div>',
                yearPicker: !0,
                yearPickerTemplate: '<div class="picker-calendar-year-picker"><a href="#" data-ajax="false"  class="link icon-only picker-calendar-prev-year"><i class="icon icon-prev"></i></a><span class="current-year-value"></span><a href="#" data-ajax="false"  class="link icon-only picker-calendar-next-year"><i class="icon icon-next"></i></a></div>',
                weekHeader: !0,
                scrollToInput: !0,
                inputReadOnly: !0,
                convertToPopover: !0,
                ...
                footerTemplate: '<div class="picker-footer"><a href="#" data-ajax="false"  class="button close-picker">{{closeText}}</a></div>'
            };
            e = e || {};
            for (var c in d)"undefined" == typeof e[c] && (e[c] = d[c]);
            p.params = e,
        ...
        i.addNotification = function(e) {
            if (e) {
                ...
                var t = a.children("ul"),
                n = i.params.notificationTemplate || '{{#if custom}}<li>{{custom}}</li>{{else}}<li class="notification-item notification-hidden"><div class="item-content">{{#if material}}<div class="item-inner"><div class="item-title">{{js "this.message || this.title || this.subtitle"}}</div>{{#if ../button}}{{#button}}<div class="item-after"><a href="#" data-ajax="false"  class="button {{#if color}}color-{{color}}{{/if}} {{#js_compare "this.close !== false"}}close-notification{{/js_compare}}">{{text}}</a></div>{{/button}}{{/if}}</div>{{else}}{{#if media}}<div class="item-media">{{media}}</div>{{/if}}<div class="item-inner"><div class="item-title-row">{{#if title}}<div class="item-title">{{title}}</div>{{/if}}{{#if closeIcon}}<div class="item-after"><a href="#" data-ajax="false"  class="close-notification"><span></span></a></div>{{/if}}</div>{{#if subtitle}}<div class="item-subtitle">{{subtitle}}</div>{{/if}}{{#if message}}<div class="item-text">{{message}}</div></div>{{/if}}{{/if}}</div></li>{{/if}}';
    ...
    var e = function() {
        ...
        e.prototype = {
            ...
            animationEnd: function(e) {
                ...
                var t,
                n = ["webkitAnimationEnd", "OAnimationEnd", "MSAnimationEnd", "animationend"],
                r = this;
                if (e) for (t = 0; t < n.length; t++) r.on(n[t], a);
                return this
            },
    ...
    window.Swiper = function(t, n) {
        ...
        if (h.version = "3.1.0", h.params = n, h.classNames = [], "undefined" != typeof a && "undefined" != typeof e && (a = e), ("undefined" != typeof a || (a = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery: e)) && (h.$ = a, h.container = a(t), 0 !== h.container.length)) {
            ...
            h.updateActiveIndex = function() {
                ...
                a,
                t,
                n = h.rtl ? h.translate: -h.translate;
